...
from ._03_02_previous_race_extractor import extract as extract_previous_races
...
class FeatureExtractor:
    ...
    def extract_previous_races(
        self, df: pd.DataFrame, sed_df: pd.DataFrame, bac_df: pd.DataFrame
    ) -> pd.DataFrame:
        ...
        return extract_previous_races(df, sed_df, bac_df)
    ...
    def extract_all_parallel(
        ...
        with ThreadPoolExecutor(max_workers=max_workers) as executor:
            ...
            futures = {
                executor.submit(extract_previous_races, df_with_datetime, sed_df, bac_df): "previous_races",
