...
/**
 * KYH（JRDB競走馬データ（KYH）- 放牧先情報なし）のフォーマット定義
 * 
 * 
 * レコード長: 552バイト
 */
export const kyhFormat: JRDBFormatDefinition = {
  dataType: 'KYH',
  description: 'JRDB競走馬データ（KYH）- 放牧先情報なし',
  recordLength: 552,
  encoding: 'ShiftJIS',
  lineEnding: 'CRLF',
  fields: [
    ...
    { name: '予備', start: 544, length: 7, type: JRDBFieldType.STRING, description: 'スペース' },
    { name: '改行', start: 551, length: 2, type: JRDBFieldType.STRING, description: 'ＣＲ・ＬＦ' },
  ]
}
