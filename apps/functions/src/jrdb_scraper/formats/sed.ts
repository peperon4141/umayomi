...
/**
 * SED（JRDB成績速報データ（SED））のフォーマット定義
 * 
 * 
 * レコード長: 376バイト
 */
export const sedFormat: JRDBFormatDefinition = {
  dataType: 'SED',
  description: 'JRDB成績速報データ（SED）',
  recordLength: 376,
  encoding: 'ShiftJIS',
  lineEnding: 'CRLF',
  fields: [
    ...
    { name: 'タイム', start: 144, length: 4, type: JRDBFieldType.INTEGER_NINE, description: '1byte:分, 2-4byte:秒(0.1秒単位)' },
    ...
    { name: 'コース取り', start: 216, length: 1, type: JRDBFieldType.INTEGER_NINE, description: '1:最内,2:内,3:中,4:外,5:大外' },
    { name: '上昇度コード', start: 217, length: 1, type: JRDBFieldType.INTEGER_NINE, description: '1:AA, 2:A, 3:B, 4:C, 5:?' },
    ...
    { name: '単勝', start: 342, length: 7, type: JRDBFieldType.INTEGER_ZERO_BLANK, description: '単位（円）' },
    { name: '複勝', start: 349, length: 7, type: JRDBFieldType.INTEGER_ZERO_BLANK, description: '単位（円）' },
    { name: '本賞金', start: 356, length: 5, type: JRDBFieldType.INTEGER_ZERO_BLANK, description: '単位（万円）' },
    { name: '収得賞金', start: 361, length: 5, type: JRDBFieldType.INTEGER_ZERO_BLANK, description: '単位（万円）' },
    { name: 'レースペース流れ', start: 366, length: 2, type: JRDBFieldType.INTEGER_NINE, description: '→成績データの説明' },
    { name: '馬ペース流れ', start: 368, length: 2, type: JRDBFieldType.INTEGER_NINE, description: '→成績データの説明' },
    { name: '4角コース取り', start: 370, length: 1, type: JRDBFieldType.INTEGER_NINE, description: '1:最内,2:内,3:中,4:外,5:大外' },
    { name: '発走時間', start: 371, length: 4, type: JRDBFieldType.INTEGER_NINE, description: 'HHMM' },
    { name: '改行', start: 375, length: 2, type: JRDBFieldType.STRING, description: 'ＣＲ・ＬＦ' },
  ]
}
