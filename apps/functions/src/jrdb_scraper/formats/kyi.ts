...
/**
 * KYI（JRDB競走馬データ - 放牧先情報を追加、最も詳細）のフォーマット定義
 * 
 * 仕様書: https://jrdb.com/program/Kyi/kyi_doc.txt
 * 使用説明: https://jrdb.com/program/Kyi/ky_siyo_doc.txt
 * サンプル: https://jrdb.com/program/Kyi/KYI150712.txt
 */
export const kyiFormat: JRDBFormatDefinition = {
  ...
  usageGuideUrl: 'https://jrdb.com/program/Kyi/ky_siyo_doc.txt',
  sampleUrl: 'https://jrdb.com/program/Kyi/KYI150712.txt',
  fields: [
    {
      name: 'レースキー',
      start: 1,
