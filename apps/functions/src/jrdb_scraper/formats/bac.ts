...
/**
 * BAC（JRDB番組データ（BAC））のフォーマット定義
 * 
 * 
 * レコード長: 184バイト
 */
export const bacFormat: JRDBFormatDefinition = {
  dataType: 'BAC',
  ...
  fields: [
    ...
    { name: '回数', start: 87, length: 8, type: JRDBFieldType.STRING, description: '第ZZ9回（全角半角混在）' },
    ...
    { name: '単勝', start: 161, length: 1, type: JRDBFieldType.INTEGER_NINE, description: '単勝（1バイト目）' },
    { name: '複勝', start: 162, length: 1, type: JRDBFieldType.INTEGER_NINE, description: '複勝（2バイト目）' },
    { name: '枠連', start: 163, length: 1, type: JRDBFieldType.INTEGER_NINE, description: '枠連（3バイト目）' },
    { name: '馬連', start: 164, length: 1, type: JRDBFieldType.INTEGER_NINE, description: '馬連（4バイト目）' },
    { name: '馬単', start: 165, length: 1, type: JRDBFieldType.INTEGER_NINE, description: '馬単（5バイト目）' },
    { name: 'ワイド', start: 166, length: 1, type: JRDBFieldType.INTEGER_NINE, description: 'ワイド（6バイト目）' },
    { name: '３連複', start: 167, length: 1, type: JRDBFieldType.INTEGER_NINE, description: '３連複（7バイト目）' },
    { name: '３連単', start: 168, length: 1, type: JRDBFieldType.INTEGER_NINE, description: '３連単（8バイト目）' },
    { name: '予備', start: 169, length: 8, type: JRDBFieldType.INTEGER_NINE, description: '予備（9バイト目）' },
    { name: 'WIN5フラグ', start: 177, length: 1, type: JRDBFieldType.INTEGER_ZERO_BLANK, description: '1～5' },
    { name: '予備', start: 178, length: 5, type: JRDBFieldType.STRING, description: 'スペース' },
    { name: '改行', start: 183, length: 2, type: JRDBFieldType.STRING, description: 'ＣＲ・ＬＦ' },
  ]
}
